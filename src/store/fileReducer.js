...
export default function fileReducer(state = initialState, action) {
    switch (action.type) {
        ...
        case PUSH_TO_STACK:
            return {...state, dirStack: [...state.dirStack, action.payload.dir], dirPath: action.payload.path}
...
export const pushToStackAction = (dir, path) => ({type: PUSH_TO_STACK, payload: {dir, path}});
export const popToStackAction = (path) => ({type: POP_TO_STACK, payload: path});
